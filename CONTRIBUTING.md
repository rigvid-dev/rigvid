Contributing to Rigvid Core
============================

The Rigvid Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Rigvid Core project, and is not to be
confused with overall Rigvid Network Protocol consensus changes.

Whether a pull request is merged into Rigvid Core rests with the project merge
...
Patches that change Rigvid consensus rules are considerably more involved than
...
Where a patchset proposes to change the Rigvid consensus, it must have been
...
The project leader is the release manager for each Rigvid Core release.
