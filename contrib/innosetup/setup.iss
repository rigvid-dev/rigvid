...
#define MyAppName "Rigvid"
#define MyAppPublisher "2022 Rigvid developers"
#define MyAppURL "https://rigvid.vip/"
#define MyAppExeName "rigvid-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/RIV/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=RigvidSetup
...
[Files]
Source: ".\package\rigvid-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Rigvid\Rigvid-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Rigvid\Rigvid-Qt,strDataDir|{userappdata}\Rigvid\}');
  Result := True;
end;
