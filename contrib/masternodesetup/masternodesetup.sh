...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='rigvid.conf'
CONFIGFOLDER='/root/.rigvid'
COIN_DAEMON='rigvidd'
COIN_CLI='rigvid-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/rigvid-dev/rigvid/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
