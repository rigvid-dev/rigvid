...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/rigvidd.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/rigvid-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/rigvid-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/rigvid.ico %{buildroot}%{_datadir}/pixmaps/rigvid.ico
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/rigvid16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/rigvid32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/rigvid64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/rigvid128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/rigvid256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/rigvid256.png %{buildroot}%{_datadir}/pixmaps/rigvid16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/rigvid256.png %{buildroot}%{_datadir}/pixmaps/rigvid32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/rigvid256.png %{buildroot}%{_datadir}/pixmaps/rigvid64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/rigvid256.png %{buildroot}%{_datadir}/pixmaps/rigvid128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/rigvid256.png %{buildroot}%{_datadir}/pixmaps/rigvid256.xpm
