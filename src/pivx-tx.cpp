...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Rigvid rigvid-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rigvid-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rigvid transaction") + "\n" +
                               "  rigvid-tx [options] -create [commands]   " + _("Create hex-encoded rigvid transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rigvid transaction
