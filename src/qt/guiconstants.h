...
/* Rigvid GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Rigvid"
#define QAPP_ORG_DOMAIN "rigvid.vip"
#define QAPP_APP_NAME_DEFAULT "Rigvid-Qt"
#define QAPP_APP_NAME_TESTNET "Rigvid-Qt-testnet"
