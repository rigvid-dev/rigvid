...
/** Utility functions used by the Rigvid Qt UI.
 */
namespace GUIUtil
{
...
// Render RIV addresses in monospace font
...
// Parse "rigvid:" URI into recipient object, return true on successful parsing
