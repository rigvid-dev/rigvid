...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RIV features */
        {"rigvid", "listmasternodes", &listmasternodes, true },
        {"rigvid", "getmasternodecount", &getmasternodecount, true },
        {"rigvid", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"rigvid", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"rigvid", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"rigvid", "masternodecurrent", &masternodecurrent, true },
        {"rigvid", "startmasternode", &startmasternode, true },
        {"rigvid", "createmasternodekey", &createmasternodekey, true },
        {"rigvid", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"rigvid", "listmasternodeconf", &listmasternodeconf, true },
        {"rigvid", "getmasternodestatus", &getmasternodestatus, true },
        {"rigvid", "getmasternodewinners", &getmasternodewinners, true },
        {"rigvid", "getmasternodescores", &getmasternodescores, true },
        {"rigvid", "preparebudget", &preparebudget, true },
        {"rigvid", "submitbudget", &submitbudget, true },
        {"rigvid", "mnbudgetvote", &mnbudgetvote, true },
        {"rigvid", "getbudgetvotes", &getbudgetvotes, true },
        {"rigvid", "getnextsuperblock", &getnextsuperblock, true },
        {"rigvid", "getbudgetprojection", &getbudgetprojection, true },
        {"rigvid", "getbudgetinfo", &getbudgetinfo, true },
        {"rigvid", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"rigvid", "mnfinalbudget", &mnfinalbudget, true },
        {"rigvid", "checkbudgets", &checkbudgets, true },
        {"rigvid", "mnsync", &mnsync, true },
        {"rigvid", "spork", &spork, true },
        {"rigvid", "getcollateral", &getcollateral, true},
...
{
    return "> rigvid-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3354/\n";
}
