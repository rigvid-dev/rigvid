...
"""Verify that starting rigvid with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rigvid with -? for help text")
        ...
        self.log.info("Start rigvid with -version for version information")
